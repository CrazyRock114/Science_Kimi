...
export const kp22ThermalProperties: KnowledgePoint = {
  ...
  "theory": {
    "zh": [
      ...
      {
        "type": "paragraph",
        "text": "持续加热冰块并记录温度。会出现两段水平平台——能量在输入，温度却不变。"
      },
      {
        "type": "formula",
    ...
    "en": [
      ...
      {
        "type": "paragraph",
        "text": "Heat ice steadily and plot the temperature. Two flat plateaus appear where energy goes in but the temperature will not move."
      },
      {
        "type": "formula",
        "latex": "E = mc\\,\\Delta\\theta",
